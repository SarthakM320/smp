...
<head>
    ...
    <meta property="og:title" content="Department - Aerospace Engineering | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Department - Aerospace Engineering | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/academics/departments/bg/aero.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Aerospace Engineering</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Aerodynamics</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Propulsion</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Structures</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Controls</p>
                    ...
                    <section id="dept-alum">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Ankit Shah, Aerospace Engg, B.Tech (2013)</p>

                                        <b>Motivations behind choosing Aero, expectations and reality?</b>
                                        <br>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Zephyr</p>
                                        ...
                                        <br><br>
                                        Visit our website <a href="http://www.aero.iitb.ac.in/zephyr" class="link">here</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Advitiy</p>
                                        ...
                                        <br><br>
                                        Visit our website <a href="http://www.aero.iitb.ac.in/satlab/" class="link">here</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Udaan</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">MSI</p>
                                        ...
                                        <br><br>
                                        Visit our website <a href="http://www.marssociety.org.in/" class="link">here</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Rakshak</p>
                                        ...
                                        <br>
                                        Visit our facebook page <a href="https://www.facebook.com/TeamRakshak" class="link">here</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">AUV</p>
                                        ...
                                        <br><br>
                                        Visit our website <a href="http://www.auv-iitb.org/Web" class="link">here</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="additional-links">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        Following is link for DAMP Blog of our Department
                                        <br>
                                        <a href="https://iitbaero.github.io/" class="link">DAMP Blog</a>
                                    </div>
                                </div>
                            </div>
                        </div>
