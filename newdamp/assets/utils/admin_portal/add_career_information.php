...
function add_career_information() {
    try{
        session_start();
        ...
        $link = linktoDAMP();
        $query1 = "SELECT COUNT(id) AS count FROM `career_information` WHERE `category1` = :category1 AND `branch` = :branch";
