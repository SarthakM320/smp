...
<head>
    ...
    <meta property="og:title" content="Academics | SMP - IIT Bombay" />
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/academics/bg.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Academics</h1>
        ...
        <div class="row">
            <div class="col-md-8 col-sm-12">
                <section id="sub_body">
                    ...
                    <section id="branch-change">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">Branch Change</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <ol class="section-ol-list">
                                            <li>
                                                ...
                                                <br>
                                                <ol class="section-ol-list alpha-list">
                                                    <li>
                                            ...
                                            <li>
                                                <ol class="section-ol-list alpha-list">
                                                    <li>
                                                        Before beginning the allocation, additional seats are made available in each branch, limited to a maximum of 10% of its sanctioned strength
                                                    </li>
                                                    <li>
                                                        While students are allotted seats of general and reserved type during admission, this data is not used during branch change. Each available seat may be occupied by students of any category.
                                                    </li>
                                                </ol>
                                            </li>
                                            <li>
                                                An eligible student's request for a shift from branch A to branch B will be considered valid if any one of the following two sets of criteria are satisfied.
                                                <br>
                                                Set 1
                                                <ol class="section-ol-list alpha-list">
                                                    <li>
                                                        The CPI of the student is at least 9
                                                    </li>
                                                    <li>
                    ...
                    <section id="sem-ex">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">Semester - Exchange</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <b>Siddhesh Biyani</b>
                                        <br>
                                        <b>Institute Secretary | International Relations</b>
                                        <br>
                                        <b>IIT Bombay</b>
                                        <br>
                                        <b>Email: <a href="mailto:isecir@iitb.ac.in" class="link">isecir@iitb.ac.in</a></b>
                                        <br>
                                        <b>Blog : <a href="https://exchangeblogiitb.wordpress.com" class="link">https://exchangeblogiitb.wordpress.com</a></b>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="side_menu">
                        ...
                        <div class="side-menu-content">
                            <ul id="side_nav">
                                ...
                                <li><a class="nav-link" href="#branch-change">Branch - Change</a></li>
                                <li><a class="nav-link" href="#sem-ex">Semester - Exchange</a></li>
                                <li><a class="nav-link" href="#cpi-calculation">Cpi Calculation</a></li>
                            </ul>
                        </div>
                    </div>
                    <div id="news_section">
