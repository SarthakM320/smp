...
<head>
    ...
    <meta property="og:title" content="Department - Mechanical Engineering | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Department - Mechanical Engineering | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/academics/departments/bg/mech.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Mechanical Engineering</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">BTech in Mechanical Engineering</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Dual Degree in Mechanical Engineering</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Honors in Mechanical Engineering</p>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Design (CADA)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Thermal and Fluid Engineering (TFE)</p>
                    ...
                    <section id="additional-info">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        Link to Department Website: <a href="http://www.me.iitb.ac.in/home/" class="link">http://www.me.iitb.ac.in/home/</a>
                                        <br>
                                        Link to Department DAMP Blog: <a href="https://mechdampiitb.github.io/" class="link">https://iitbmechdamp.wordpress.com/</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="dept-alum">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Antariksh Bothale, Mechanical Engineering Dual Degree (2011)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Chinmay Deo, Mechanical Engineering Dual Degree, Minor in Electrical Engineering (2013)</p>
                                        ...
                                        <ol class="section-ol-list">
                                            <li>
                                                Always be humble - all of you will have this realization as soon as you enter IIT and meet people who are better than you in almost every field imaginable(both in and out of the classroom)
                                            </li>
                                            <li>
                                                Use the next 4/5 years to try as many new things as possible without fear of failure - you will never get this freedom again. Learn to fail at things - most people entering IIT have only experienced success for all of their life.
                                            </li>
                                            <li>
                                                Do not be blindly influenced by what other people say - There will always be people around you telling you to do certain things, or to do things in a certain way. Listen to their opinion, consider it, and then do what you feel is right
                                            </li>
                                            <li>
                                                Your opinion about most things will change, as will your likes/dislikes - you, your parents, and your friends should be prepared for it
                                            </li>
                                            <li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">IITB Racing</p>
                                        ...
                                        <br><br>
                                        Visit our website <a href="http://www.iitbracing.org//" class="link">here</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Radiance</p>
                                        ...
                                        <br><br>
                                        Visit our website <a href="http://www.radianceiitb.org/" class="link">here</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
