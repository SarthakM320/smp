...
<head>
    ...
    <meta property="og:title" content="Department - Chemical Engineering | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Department - Chemical Engineering | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/academics/departments/bg/chem.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Chemical Engineering</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Honors in Chemical Engineering</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Dual Degree (DD) Program</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">B. Tech Project (BTP)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Undergraduate Research Award (URA01)</p>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Thermodynamics and Kinetics</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Reactor Design</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Equipment Design</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Piping and Instrumentation</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Control and Automation</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Environmental Concerns</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">New Materials</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Nanotechnology</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Microfluidics</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Packaging and Delivery</p>
                                        ...
                                        <br><br>
                                        <b>Moral of the Story</b>: Chemical engineering is a diverse field which transcends boundaries by incorporating elements from many disciplines. A chemical engineer could be devising or characterizing catalysts, designing new and more efficient plant equipment, improving control strategies, formulating new fuels and energy sources, ameliorating packaging and transport, and much more.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="what-after">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">
                                        What after you are a Chemical Engineer?
                                    </h2>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <section id="dept-alum">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Paridhi Agrawal, B.Tech, 2016</p>
                    ...
                    <section id="student-activities">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Azeotropy</p>
                                        ...
                                        <br><br>
                                        Visit our website <a href="https://www.azeotropy.org/" class="link">here</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
