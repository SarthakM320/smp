...
<head>
    ...
    <meta property="og:title" content="Department - Computer Science and Engineering | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Department - Computer Science and Engineering | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/academics/departments/bg/cs.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Computer Science and Engineering</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <blockquote class="blockquote">
                                            <p class="mb-0"><span style="font-size: 1.75em; line-height:0">“</span> Computer science is not really about computers -- and it's not about computers in the same sense that physics is not really about particle accelerators, and biology is not about microscopes and Petridishes...and geometry isn't really about using surveying instruments. Now the reason that we think computer science is about computers is pretty much the same reason that the Egyptians thought geometry was about surveying instruments: when some field is just getting started and you don't really understand it very well, it's very easy to confuse the essence of what you're doing with the tools that you use. <span style="font-size: 1.75em; line-height: 0;">”</span></p>
                                            <footer class="blockquote-footer">Hal Abelson</footer>
                                        </blockquote>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        A study in Computer Science is not all about coding or learning multiple programming languages as it is popularly thought. In fact, it is not even all about computers. The most crucial chunk of what you will take away from a B. Tech in CSE, IITB is much different. The B. Tech. curriculum is designed to introduce an undergraduate student to the entire breadth of the field of Computer Science and Engineering with a huge diversity in the courses. While the mandatory core curriculum rarely goes into the depths of any particular field, the department offers numerous electives that the students can take up based on the sub-disciplines that interest them. The B. Tech. programme at IIT Bombay is one of the most flexible among all IITs, with a very lean mandatory component - called the core curriculum, leaving you plenty of time to explore the various fields that interest you - CSE or otherwise. True to its name, a B. Tech. study in CSE, IITB has two major components. - Science and Engineering. But, before that you will be acquainted with the crucial tool that will enable the study of Computer Science and all of Engineering - Programming. This will majorly be in your first year where students of all departments will take up an introductory course in programming. In addition, CSE first years will also have an advanced programming course, where they will be introduced to a number of programming paradigms. “Science” will occupy the major chunk of your courses in your second year. You will be introduced to courses in Data Structures, Algorithms, Discrete Mathematics, Theoretical Machines, Logic, Computability, etc. Once you’ve learnt enough science, you will learn how to apply them and create and design stuff a.k.a. engineering. This is what you would be doing in your third year with courses like Operating Systems, Computer Architecture, Networks, Databases. Artificial Intelligence, etc. The curriculum ensures that there is a mix of science and engineering in all the semesters so that you don’t get bored. The final year is left free to explore those fields that most interest you. This is in the form of electives - in the department and otherwise and also through an optional B. Tech. Project (BTP). Below are a few sub-disciplines of Computer Science and Engineering that you will be introduced to as part of the curriculum with an amalgamation of both the science and engineering components to it.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Honors in Computer Science</p>
                                        A B. Tech. student is said to have “Graduated with Honours in Computer Science and Engineering” when she/he has done a certain number of courses from the honours course list of the department over and above the normal credit requirement (24 credits are required from the 2014 batch). These courses are typically done in the second, third and fourth years. The exact details of the programme are clearly specified in the academic rulebook of the Institute. The department has a fairly flexible honor programme allowing the choice of a great number of courses for the honors requirements. Many undergraduate courses are offered as honors courses and every postgraduate course usually is. You will be informed in detail about the exact format of the same after your first year.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">B. Tech. Project</p>
                                        Previously a mandatory component of the B. Tech curriculum, the B. Tech. project (BTP) is now optional. The BTP is a yearlong project that allows you to have a taste of research at the undergraduate level. You can choose any sub-field in CS that interests you the most and work on a new, unsolved research problem under the guidance of a professor.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">RnD Project</p>
                                        This is also an optional component. It is a semester long project that allows you to get an idea of research before taking the BTP Project. This is just a mini version of BTP Project.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Seminars</p>
                                        This is generally a 3 credit course picked up by students to get an idea of the research field they might be interested in. This allows you to explore your research interest in CS before seriously taking it up. Contrary to the RnD that involves "development" or programming component, seminar generally involves only literature survey.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="core">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Algorithms and complexity</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Artificial Intelligence</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Compilers and Programming Languages</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Theory of Computation and logic</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Data Security</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Computer systems</p>
                    ...
                    <section id="what-after">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">
                                        What after you are a CS Engineer?
                                    </h2>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <blockquote class="blockquote">
                                            <p class="mb-0"><span style="font-size: 1.75em; line-height:0">“</span> Computer science is no more about computers than astronomy is about telescopes, biology is about microscopes or chemistry is about beakers and test tubes. Science is not about tools, it is about how we use them and what we find out when we do. <span style="font-size: 1.75em; line-height: 0;">”</span></p>
                                            <footer class="blockquote-footer">Michael R. Fellows</footer>
                                        </blockquote>
                    ...
                    <section id="dept-alum">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Pararth Shah, CSE B.TEch (2013)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Vishnu Vinjam, CSE B.Tech (2014)</p>
                                        <b>Brief Intro:</b>
                                        <br>
                                        ...
                                        <br><br>
                                        <b>Exciting areas in the Field?</b>
                                        <br>
                                        ...
                                        <br><br>
                                        <b>What all I was involved in at IITB?</b>
                                        <br>
                                        ...
                                        <br><br>
                                        <b>What CSE Department taught me?</b>
                                        <br>
