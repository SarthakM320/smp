...
<head>
    ...
    <meta property="og:title" content="Department - Electrical Engineering | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Department - Electrical Engineering | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/academics/departments/bg/elec.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Electrical Engineering</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">B.Tech Program</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Honors in Electrical Engineering</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Dual Degree Programme</p>
                                        The Dual Degree Programme in EE at IITB is offered in the specializations mentioned below:
                                        <br>
                                        <ol class="section-ol-list">
                                            <li>CSP (Communication and Signal Processing)</li>
                                            <li>Control and Computing</li>
                                            <li>Power engineering and Power systems</li>
                                            <li>Integrated Circuits and Systems</li>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br>
                                        <b>Communications</b> : Transmission and Reception of data, Understanding internet network, wireless technology, 3G/4G communication technology. These courses involve applications of probability and combinatorics.
                                        <br>
                                        <b>Signal Processing</b> : There are several courses that involve Linear Algebra, Probability, Optimization which have applications like face recognition, voice recognition, motion detection, data compression etc. This field has some overlap with computer science topics. This area will involve coding that you will gradually learn through these courses.
                                        <br><br>
                                        <b>Fourth year</b> : It is very flexible, most of the curriculum comprising electives. Choosing your own electives provides you the freedom to either dive deeper in a particular area or to pursue multiple areas.
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Microelectronics and VLSI Design:</p>
                                        ...
                                        <ol class="section-ol-list">
                                            ...
                                            <li>
                                                Modelling and simulating newer designs for the next generation devices which would be of the nanometre scale
                                            </li>
                                            <li>
                                        ...
                                        <ol class="section-ol-list">
                                            ...
                                            <li>
                                                RF Circuit (High frequency) design
                                            </li>
                                            <li>
                                        ...
                                        <ol class="section-ol-list">
                                            <li>
                                                Processor Designing (you can learn how to design a good processor and will be able to think how to design 8085, ARM).
                                            </li>
                                            <li>
                                                Computer Architecture (role of each functional block in a multi-core processor.
                                            </li>
                                            <li>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Power Electronics and Power Systems</p>
                                        Future is energy, and that’s what this aspect of EE focuses on. Whatever be the source of energy, it is converted into Electrical energy which is easier to transmit as well as use. This field concentrates on improving the conversion mechanisms and the transmission.
                                        <br><br>
                                        What you can expect from courses in this area:
                                        <ol class="section-ol-list">
                                            <li>
                                            ...
                                            <li>
                                                Manage power plants and analyze power distribution systems (the power grid)
                                            </li>
                                        </ol>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Control and Computing</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Electronic Systems</p>
                    ...
                    <section id="important-links">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        DAMP Blog: <a href="https://dampeeiitb.wordpress.com" class="link">https://dampeeiitb.wordpress.com</a>
                                        Department website: <a href="https://www.ee.iitb.ac.in" class="link">https://www.ee.iitb.ac.in</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <p class="section-sub-heading mb-1">Parthe Pandit, Dual Degree (CSP) – 2015</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Gururaj Saileshwar, Dual Degree (Micro) – 2014</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Parth Kothari, B Tech (2018)</p>
                                        ...
                                        <br><br>
                                        Why IITB-EE? (How does it compare to other universities and other branches)
                                        <br>
                                        What do I expect in my 4 years in the EE Department?
                                        <br>
                                        How hard or easy are things going to be?
                                        <br>
                                        ...
                                        <br><br>
                                        So coming to the first question. <b>Why IITB-EE?</b>
                                        <br><br>
                                        ...
                                        <br><br>
                                        This brings me to my second question. <b>What can I expect in my 4 years in EE Department?</b>
                                        <br><br>
                                        ...
                                        <br><br>
                                        So finally <b>How hard or easy are things going to be?</b>
                                        <br><br>
                                        ...
                                        <br><br>
                                        And the one final question, which I asked myself after IITB EE. <b>Is it WORTH it?</b>
                                        <br><br>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Shalaka Kulkarni, B Tech (2018)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Abhin Shah, B Tech (2018)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Saurabh Pinjani (B.Tech 2018)</p>
