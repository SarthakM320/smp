...
<head>
    ...
    <meta property="og:title" content="Department - MEMS | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Department - MEMS | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/academics/departments/bg/meta.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Metallurgical Engineering and Materials Science</h1>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <section id="sub_body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <span class="text-custom-light">Here's a glimpse of what we do at Department of Metallurgical Engineering and Material Sciences(MEMS)</span>
                                        <br><br>
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" width="560" height="315" src="https://www.youtube.com/embed/3GlYo4mwbQg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                        </div>
                                        <br>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        The courses not only provide a fundamental understanding of the subject but also excite the students to explore the vast field of materials science and engineering.                                    </div>
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Healthcare and Bio-material</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Extreme Materials</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Semiconductor Electronics</p>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Future studies</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Core Sector</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Non-core sector</p>
                    ...
                    <section id="dept-alum">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Anand Garde, MEMS (1967)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Saransh Singh, MEMS Dual Degree, 2013</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Ashwin Ganapathy, MEMS Dual Degree, 2013</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Yash Sheth, MEMS Dual Degree, 2014</p>
                                        ...
                                        <ol class="section-ol-list">
                                            <li>
                                                I was looking forward to a combined "study + fun" environment and IIT-B had a perfect balance of both, a rigorous curriculum and plethora of activities going in and around the campus which helps for overall growth
                                            </li>
                                            <li>
                                                I lived in Bombay so it would be convenient to enjoy both independent life as well as spending time with family.
                                            </li>
                                            <li>
                                                Being in the city, one would expect the job scene to be better than other IITs (Which was bubble that bursts when one gets to know of placements@IITs though the jobs are pretty good but the salary quoted in the newspapers are for a few and after the foreign currency conversion rates but do not consider the PPP, however let that be a topic for another day)
                                            </li>
                                        </ol>
                    ...
                    <section id="department-activities">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Metals and Materials Association</p>
                                        ...
                                        <br><br>
                                        Visit our website <a href="http://www.padarth.org/" class="link">here</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Dhatuki</p>
                                        ...
                                        <br><br>
                                        Dhatuki is not just a newsletter. It is a mission to explore the field of materials science, to get its readers enthused about the latest buzz in materials research and to acquaint them with all the golden opportunities that shall be knocking at their doors in the near future. To read the current edition please click <a href= "https://bighome.iitb.ac.in/index.php/s/GZQQyCn7Pr3xYKj" target = "_blank" class = "link">here</a>

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Materials Special Interest Group (SIG)</p>
                                        The Materials SIG is a group of undergraduate students across all years of study at IITB who share a common passion for Materials Science and Engineering.  Besides the constant ongoing discussions on the group, we also hop on a weekly call to debate and discuss on a pre-decided topic to broaden our horizons. The discussions build from scratch and are ideal for participants with zero knowledge to advanced knowledge. The idea is not to cover the depth but the span and appreciate the breadth or as one of our Professor's like to put it "
                                        <br><br>
                                        When one looks at the story beginning from Big Bang to Quarks, evolution of the universe and life on earth followed by gradual developments over centuries and then the explosion of science and technology, it is too impressive and a life is too short to digest all of this exciting stuff. But then it is good to 'taste' whatever we can afford to 'taste'. After all, each one of us needs to remain inspired."
                                        <br><br>
                                        We are opening the next three weekly sessions to prospective students who wish to explore what the Department and the field entail so that they can make an informed decision about joining the Department in the 2021 IITB undergraduate intake. The topics are:
                                        <br>
                                        <ul class="section-ul-list">
                                            <li><b>11th Oct (10-11 pm)- Materials for clothing for soldiers to keep them warm</b>
                                                <br>We will be joined by Prof Parag Bharagava for this one. Thinking and planning development of clothes for army personnel who are serving in the subzero conditions in difficult terrain. The clothing needs to make their life slightly easier by providing desired insulation, breathability etc and must be lightweight and convenient to wear. Another variant in the same line of need is the possibility of having heated clothing using batteries. India is currently in the process of importing these in large quantities.
                                                <br></li>
                                            <li><b>18th Oct (10-11 pm) - Structural Materials for Satellites</b>
                                                <br>Materials science has for long played a major role in the advancement of technologies. One of the frontiers for this development has been space technology. Materials which are both light and strong are required for these applications. In this discussion, we will be talking about how materials have evolved and what lies in the future of this domain.
                                            </li>
                                            <li><b>25th Oct  (10-11 pm) - Materials to bring emerging megacities to the next level</b>
                                                <br>A nation's growth can be measured by the level of sophistication prevailing in its emerging megacities. But often there are material limitations to what can be achieved. These materials can make or break situations pertaining to climate change, urban planning, traffic control, and overall quality of life. Current developments in materials science like perovskite solar cells, materials for energy storage, better concrete and glass, sensor materials have enabled future cities to be more sustainable and utopian.
                                            </li>
                                        </ul>
                                        <br>
                                        Every participant is encouraged to read up on the topic a little bit in the preceding week but we're always open to curious participants who are here to just listen and ask questions. If you wish to attend any of these, please drop an email to <a href = "mailto:rohit2yadav99@gmail.com" class = "link">rohit2yadav99@gmail.com</a>. Please remember we only have limited spots and we will confirm your participation on a first come first serve basis. Please drop an email ASAP if you wish to attend!
                                    </div>
                                </div>
                            </div>
                        </div>
