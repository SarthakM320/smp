...
<head>
    ...
    <meta property="og:title" content="Extra-Curriculars | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Extra-Curriculars | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/extra_curricular/bg.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Extra-Curriculars</h1>
                ...
                <section id="sub_body">
                    ...
                    <section id="gymkhana">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">Gymkhana</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <section id="culturals">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">Culturals</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br>
                                        Webpage: <a href="https://gymkhana.iitb.ac.in/~cultural" class="link">gymkhana.iitb.ac.in/~cultural</a>
                                        <br>
                                        Facebook Page : <a href="https://facebook.com/IITBCult" class="link">facebook.com/IITBCult</a>

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Structure</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Cultural Clubs</p>

                                        <b>Literary Arts: Literati</b>
                                        <br>
                                        ...
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/IITBLitzkrieg"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://www.instagram.com/literati_iitb/"><i class="fa fa-instagram" style="color: rebeccapurple;"></i></a>
                                            <a href="https://www.insti.app/org/literati"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                            <!--<a href="facebook.com"><i class="fa fa-external-link-square" style="color: lightcoral;"></i></a>-->
                                        </div>

                                        <br><br>
                                        <b>Dramatics: Fourth Wall</b>
                                        <br>
                                        ...
                                        <br>
                                        Connect to Fourth Wall:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/IITBombay.fourthwall/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://fourthwalliitb.wordpress.com/"><i class="fa fa-external-link-square" style="color: lightcoral;"></i></a>
                                            <a href="https://www.insti.app/org/fourthwall"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                        </div>

                                        <br><br>
                                        <b>Music: Staccato and Saaz</b>
                                        <br>
                                        ...
                                        Connect to Staccato:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/groups/164746973612850/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                        </div>
                                        <br>
                                        Connect to Saaz:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/groups/297282286951897"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                        </div>

                                        <br><br>
                                        <b>Film and Media: Silverscreen</b>
                                        <br>
                                        ...
                                        <br>
                                        Connect to Silverscreen:
                                        <div class="content-links">
                                            <a href="https://www.instagram.com/silverscreen_iitb/"><i class="fa fa-instagram" style="color: rebeccapurple;"></i></a>
                                            <a href="https://www.youtube.com/user/silverscreeniitb"><i class="fa fa-youtube-play" style="color: red;"></i></a>
                                            <a href="https://www.insti.app/org/silverscreen"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                        </div>
                                        ...
                                        Connect to In Sync:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/groups/insynciitb/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://www.instagram.com/insync_iitb/"><i class="fa fa-instagram" style="color: rebeccapurple;"></i></a>
                                            <a href="https://www.youtube.com/channel/UCp0-MwKqWJgJNY81nwLrW0w"><i class="fa fa-youtube-play" style="color: red;"></i></a>
                                            <a href="https://www.insti.app/org/insync"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                        </div>

                                        <br><br>
                                        <b>Debating: We-Speak and Vaani</b>
                                        <br>
                                        ...
                                        Connect to We-Speak:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/groups/wespeak.iitb/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://www.instagram.com/wespeakiitb/"><i class="fa fa-instagram" style="color: rebeccapurple;"></i></a>
                                            <a href="https://www.insti.app/org/we-speak"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                        </div>
                                        <br>
                                        Connect to Vaani:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/vaani.iitb/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://www.instagram.com/vaani_iitb/"><i class="fa fa-instagram" style="color: rebeccapurple;"></i></a>
                                            <a href="https://www.youtube.com/c/VaaniIITBombay"><i class="fa fa-youtube-play" style="color: red;"></i></a>
                                            <a href="https://vaani380.wordpress.com/"><i class="fa fa-external-link-square" style="color: lightcoral;"></i></a>
                                            <a href="https://www.insti.app/org/vaani"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                        </div>

                                        <br><br>
                                        <b>Photography and Fine Arts - Rang and Pixels</b>
                                        <br>
                                        ...
                                        Connect to Rang:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/RANG.IITB/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://www.instagram.com/rang_iitb/"><i class="fa fa-instagram" style="color: rebeccapurple;"></i></a>
                                            <a href="https://rang-iitb.blogspot.com/"><i class="fa fa-external-link-square" style="color: lightcoral;"></i></a>
                                            <a href="https://www.insti.app/org/rang"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                        </div>
                                        <br>
                                        Connect to Pixels:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/PixelsIITB/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://www.instagram.com/pixels_iitb/"><i class="fa fa-instagram" style="color: rebeccapurple;"></i></a>
                                            <a href="https://www.pixelsiitbombay.com/"><i class="fa fa-external-link-square" style="color: lightcoral;"></i></a>
                                            <a href="https://www.insti.app/org/pixels"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                        </div>
                                        ...
                                        <br>
                                        Connect to Design Club:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/thedesignclubiitb/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://www.youtube.com/channel/UCT-H_0-ai4YaReSqboTiXPA"><i class="fa fa-youtube-play" style="color: red;"></i></a>
                                            <a href="https://www.insti.app/org/the-design-club"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                        </div>

                                        <br><br>
                                        <b>Classical & Folk Arts - Roots</b>
                                        <br>
                                        ...
                                        Connect to Roots:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/groups/RootsIITB/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://www.instagram.com/roots_iitb/"><i class="fa fa-instagram" style="color: rebeccapurple;"></i></a>
                                            <a href="https://www.youtube.com/channel/UCYOtCVjIqR9_PoulDX_3goQ"><i class="fa fa-youtube-play" style="color: red;"></i></a>
                                            <a href="https://www.insti.app/org/roots"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                        </div>

                                        <br><br>
                                        <b>Fashion Club – Style Up</b>
                                        <br>
                                        ...
                                        Connect to Style Up:
                                        <div class="content-links">
                                            <a href="https://www.facebook.com/styleup.iitb/"><i class="fa fa-facebook-square" style="color: darkblue;"></i></a>
                                            <a href="https://www.instagram.com/styleup_iitb/?hl=en"><i class="fa fa-instagram" style="color: rebeccapurple;"></i></a>
                                            <a href="https://www.youtube.com/channel/UCLB_Gh4fQQohPGdw-G-Bavg"><i class="fa fa-youtube-play" style="color: red;"></i></a>
                                            <a href="https://www.insti.app/org/lifestyle-club"><img src="assets/img/extra_curricular/favicon-32x32.png"></a>
                                            <!--<a href="facebook.com"><i class="fa fa-external-link-square" style="color: lightcoral;"></i></a>-->
                                        </div>

                                        <br><br>
                                        <b>Intra College events</b>
                                        <br>
                                        ...
                                        <br><br>
                                        <b>Performing Arts Festival (PAF)</b>
                                        <br>
                    ...
                    <section id="media">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">Media @IIT Bombay</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Newsletters and Magazines</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Insight</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">IIT Bombay Broadcasting Channel</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">EnSpace</p>
                                        E-Cell publishes a magazine EnSpace which aims to promote entrepreneurial awareness through an interesting mix of articles, interviews and informative pieces. You can find the EnSpace publications <a href="https://ecell.in/enspace" class="link">here</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="sports">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Introduction</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Facilities</p>
                                        ...
                                        <br><br>
                                        <table class="table table-condensed section-table-2">
                                            <tbody>
                                                <tr>
                                                    <td>AQUATICS</td>
                                                    <td>ATHLETICS</td>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Sports for everyone</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Aavhan</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">The Council</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Championships</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Inter IIT Championships</p>
                                        ...
                                        <br><br>
                                        To know more about Sports at IIT Bombay, visit <a href="https://gymkhana.iitb.ac.in/~sports/" class="link">https://gymkhana.iitb.ac.in/~sports/</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section id="technical-affairs">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">Technical Affairs</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">The Tech Scene</p>
                                        ...
                                        <ul class="section-ul-list">
                                            <li>
                                                <b>XLR8</b>: This is your first hand at tinkering and building something on your own. You get your hands dirty to make a bluetooth operated robotic car for a competition with attractive prizes which is held late in August. But we warn you - the feeling you get in seeing something that you have made actually work is enthralling as hell!
                                            </li>
                                            <li>
                                                <b>Scratch Day</b>: Dive head first into programming with a fun game building competition held among all freshmen. Scratch is a visual programming language that provides an easy way to start coding even if you haven’t done any before. Watch out for pizzas and prizes to be won!
                                            </li>
                                            <li>
                                                <b>Mathathon</b>: Show off your mathematical prowess; level up as you pass through multiple stages of difficulty in this marathon math problem solving contest. This is the ultimate showdown for all you math lovers.
                                            </li>
                                            <li>
                                                <b>Bazinga</b>: Go beyond usual problems in physics and maths and put your thinking abilities to test as you answer interesting conceptual questions in this team based quiz contest. If you are a fan of pure thought and imagination, this event is for you.
                                            </li>
                                            <li>
                                                <b>Line Following Bot competition</b>: Held in the first week of January, it will introduce you to more advance electronics stuff like control algorithms, microcontrollers and sensors. It is not only a platform to automate but to innovate as well.
                                            </li>
                                            <li>
                                                <b>Web Designing</b>: Be ready to unleash your creativity and your coding prowess to design awesome websites. Get a chance to feature on the WnCC website zone this October with your website design.
                                            </li>
                                            <li>
                                                <b>RC Plane Competition</b>: Held in September and October, this competition involves designing, building and flying a radio-controlled airplane. You will be introduced to the basics of what makes an airplane fly (hint: not magic), including Aerodynamics and Flight Dynamics.
                                            </li>
                                            <li>
                                                <b>Trip to Giant Metrewave Radio Telescope (GMRT)</b>: Watching the night sky and the stars slowly changing position as the earth revolves is a wondrous experience and observing this at GMRT, Pune is a once in a lifetime opportunity. We will be taking more than 10 telescopes so all of you can learn to handle a telescope and enjoy the night sky. Also, you might get an opportunity to attend lectures of great astrophysicists at NCRA, Pune.
                                            </li>
                                            <li>
                                                <b>General Astronomy Quiz (August)</b>: An open institute quiz where all the astro enthusiasts gather and showcase their ‘dexterity’ in the fields of Observational, Theoretical Astronomy. Usually takes place in the first month of the Odd semester, the General Astronomy Quiz comprises of fun, tricky, puzzling questions which require rather simple concepts in Astronomy, Physics but indeed a lot of common sense. Loads of interesting prizes at stake!
                                            </li>
                                            <li>
                                                <b>Tech Weekend</b>: In the beginning of February, be prepared for some heavy Tech action as a slew of workshops and competitions over a weekend put you in a state of Tech nirvana.
                                            </li>
                                            <li>
                                                <b>Institute Technical Summer Projects</b>: Over the summers, several freshmen and seniors alike stay back in the Institute for some heavy-duty tech action. It is a platform for you to test your tech mettle and build uber-cool stuff you have always thought should exist. The Technical Council gives you everything you need to give wings to your dream ideas be it a Humanoid Robot or a Quadcoptor like in movie 3 Idiots. Anythings is possible!
                                            </li>
                                            <li>
                                                <b>Summer of Science</b>: SoS is an initiative to help you explore those fields in science that you always wanted to learn, but couldn't, due to lack of proper guidance or resources.
                                                <br>
                                            ...
                                            <li>
                                                <b>Crime Scene Investigation</b>: The Crime scene where you become the detectives. Show away your investigating skills in the forensics. This is your first encounter with biotechnological application!
                                            </li>
                                        </ul>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Aeromodelling Club</p>
                                        ...
                                        <br><br>
                                        <!--To know more about us, visit our website <a href="http://stab-iitb.org/aeromodelling-club" class="link">http://stab-iitb.org/aeromodelling-club</a>.-->

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Biotech Club</p>
                                        ...
                                        <br><br>
                                        <!--To know more about us, visit our website <a href="http://stab-iitb.org/biotech/" class="link">http://stab-iitb.org/biotech/</a>.-->

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Electronics and Robotics Club</p>
                                        ...
                                        <br><br>
                                        <!--To know more about us, visit our website <a href="http://stab-iitb.org/erc/" class="link">http://stab-iitb.org/erc/</a>.-->

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Energy Club</p>
                                        ...
                                        <br><br>
                                        To know more about us, visit our website <a href="https://enclub.github.io/home/" class="link">https://enclub.github.io/home/</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Krittika - The Astronomy Club</p>
                                        ...
                                        <br><br>
                                        <!--To know more about us, visit our website <a href="http://stab-iitb.org/krittika/" class="link">http://stab-iitb.org/krittika/</a>.-->

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Math & Physics Club</p>
                                        ...
                                        <br><br>
                                        To know more about us, visit our website <a href="http://mnp-club.github.io/" class="link">http://mnp-club.github.io/</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">WnCC - Web and Coding Club</p>
                                        ...
                                        <br><br>
                                        To know more about us, visit our website <a href="http://www.wncc-iitb.org/" class="link">http://www.wncc-iitb.org/</a>.
                                        <br><br>
                                        ...
                                        <br>
                                        <a href="https://wncc-iitb.org/wiki" class="link">https://wncc-iitb.org/wiki</a>

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Tinkerers’ Lab</p>
                                        ...
                                        <br><br>
                                        To know more about us, visit our website <a href="https://tinkerers-lab.org/" class="link">https://tinkerers-lab.org/</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Technovation</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Exo-Fly</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">UMIC</p>
                                        ...
                                        <br>
                                        Please visit our website <a href="http://www.umiciitb.com" class="link">http://www.umiciitb.com</a> for more information.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Advitiy - The IIT Bombay Student Satellite (Previously, known as Pratham)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">IIT Bombay Racing</p>
                                        ...
                                        <br>
                                        To know more about us, visit our website <a href="http://www.iitbracing.org" class="link">http://www.iitbracing.org</a>!

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Team Shunya</p>
                                        ...
                                        <br><br>
                                        You can find more details at <a href="http://teamshunya.in/home.php" class="link">http://teamshunya.in/home.php</a>

                                        <br><br>
                                        <p class="section-sub-heading mb-1">IIT-B Mars Rover Team</p>
                                        ...
                                        <br><br>
                                        Have a look at <a href="https://iitbmartian.github.io" class="link">https://iitbmartian.github.io</a> for further information and latest updates about the team.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Autonomous Underwater Vehicle</p>
                                        ...
                                        <br><br>
                                        To know more about us, visit our website <a href="http://www.auv-iitb.org" class="link">http://www.auv-iitb.org</a>.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Inter College Festivals</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Where to Begin</p>
                    ...
                    <section id="ibs">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">IBs</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">NSS</p>
                                        <br>
                                        <b>NSS IIT Bombay</b>
                                        <br>
                                        ...
                                        <br><br>
                                        For more details, you may visit <a href="https://nss.iitb.ac.in/home/" class="link">NSS IIT Bombay website</a> or facebook page.

                                        <br><br>
                                        <p class="section-sub-heading mb-1">SARC</p>
                                        ...
                                        <br>
                                        <a href="http://www.facebook.com/saathi.iitb" class="link">http://www.facebook.com/saathi.iitb</a>
                                        <br>
                                        <a href="mailto:saathi.iitbombay@gmail.com" class="link">saathi.iitbombay@gmail.com</a>

                                        <br><br>
                                        <p class="section-sub-heading mb-1">NCC</p>
                                        ...
                                        <br><br>
                                        To know more about mood indigo please visit <a href="https://moodi.org/" class="link">https://moodi.org/</a>
                                        <br><br>
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item" width="560" height="315" src="https://www.youtube.com/embed/f4haw4C8gZk" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                        </div>

                                        <br><br>
                                        <p class="section-sub-heading mb-1">Techfest</p>
                                        ...
                                        To know more visit us at:
                                        <br>
                                        <a href="https://www.techfest.org" class="link">www.techfest.org</a>
                                        <br>
                                        <a href="https://www.facebook.com/techfest.iitb" class="link">www.facebook.com/techfest.iitb</a>
                                        <!--
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Entrepreneurship Cell</p>
                                        ...
                                        <br><br>
                                        <b>Our primary initiatives include</b>:
                                        <ol class="section-ol-list">
                                            <li>
                                                Entrepreneurship and Business (EnB) Club:
                                                <br>
                                            ...
                                            <li>
                                                Eureka!, Asia's largest B-Model Competition:
                                                <br>
                                        ...
                                        To know more Visit us at
                                        <br>
                                        <a href="https://www.ecell.in" class="link">www.ecell.in</a>
                                        <br>
                                        <a href="https://www.facebook.com/ecell.in" class="link">www.facebook.com/ecell.in</a>
                                        -->
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Abhyuday</p>
                                        ...
                                        <br><br>
                                        To know more about Abhyuday, do visit <a href="https://www.facebook.com/abhyuday.iitb/" class="link">https://www.facebook.com/abhyuday.iitb/</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="side">
                    <div id="side_menu">
                        ...
                        <div class="side-menu-content">
                            <ul id="side_nav">
                                <li><a class="nav-link active" href="#gymkhana">Gymkhana</a></li>
                                <li><a class="nav-link" href="#culturals">Culturals</a></li>
                                <li><a class="nav-link" href="#media">Media @IIT Bombay</a></li>
                                <li><a class="nav-link" href="#sports">Sports</a></li>
                                <li><a class="nav-link" href="#technical-affairs">Technical Affairs</a></li>
                                <li><a class="nav-link" href="#ibs">IBs</a></li>
                            </ul>
                        </div>
                    </div>
                    <div id="news_section">
                        ...
                        <div class="news-content">
                            <ul>
                                <li style="font-size: 0.75em;"><sup><img src="assets/img/new.gif" alt=""></sup><a href="covid.php" target="_blank">COVID-19 updates in IITB</a></li>
