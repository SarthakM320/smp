...
<head>
    ...
    <meta property="og:title" content="Women | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Women | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/women/bg.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Women</h1>
                ...
                <div id="side">
                    <div id="side_menu">
                        ...
                        <div class="side-menu-content">
                            <ul id="side_nav">
                                <li><a class="nav-link active" href="#gender-cell">Gender Cell</a></li>
                                <li><a class="nav-link" href="#helpline">Helpline</a></li>
                            </ul>
                        </div>
                    </div>
                    <div id="news_section">
