...
<head>
    ...
    <meta property="og:title" content="For Parents | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>For Parents | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/for_parents/bg.jpg');">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >For Parents</h1>
			...
			<div class="hero__btn" data-animation="fadeInLeft" data-delay="1.1s">
                            <a href="https://smp.gymkhana.iitb.ac.in/covid.php" class="btn custom-btn"><span>COVID-19 IIT Bombay</span><i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-8 col-sm-12">
                <section id="sub_body">
                    ...
                    <section id="letter-to-parents">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">Letter to Parents</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Institute Student Mentor Programme (ISMP)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Academic Structure</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Hostel Life</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Some important issues</p>
                    ...
                    <section id="hindi-parents-letter">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">अभिभावक को पत्र</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <b>पप्रिय माता-पिता / अभिभावक,</b>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">इंस्टीट्यूट छात्र मंथन कार्यक्रम (आईएसएमपी )</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">छात्रावास जीवन</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">वित्तीय सहायता</p>
                                        ...
                                        <b>शुभकामनाएँ सहित</b> ,
                                        <br>
                                        <b>विद्यार्थी परामर्शदाता कार्यक्रम</b>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="scholarships-available">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2 class="section-heading">Scholarships Available</h2>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
...
<!--                                        Main Scholarships-->
                                        ...
                                        <p class="section-sub-heading mb-1">Scholarship Given</p>
                                        <br>
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Income Limit</th>
                                                    <th colspan="2"></th>
                                                    <th colspan="2">SC / ST Category Students</th>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                                    <th>Women</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Income Upto Rs. 1L</td>
                                                    <td>
                                                        Exemption from payment. of tuition fees
                                                        MCM Rs. 40,000 per year
                                                        Women merit scholarship of Rs. 10,000 per year
                                                    </td>
                                                    <td>
                                                        Exemption from payment. of tuition fees
                                                        MCM Rs. 40,000 per year.
                                                    ...
                                                    <td>
                                                        Exemption from payment. of tuition fees Women merit scholarship of Rs. 10,000 per year
                                                        <ol class="section-ol-list">
                                                            <li>Free messing</li>
                                                            <li>Pocket allowance @ 500 p.m</li>
                                                            <li>Exception of payment hostel rent</li>
                                                        </ol>
                                                    </td>
                                                    <td>
                                                        Exemption from payment. of tuition fees
                                                ...
                                                <tr>
                                                    <td>Income above Rs. 1L to 3L</td>
                                                    <td>
                                                        Exemption from payment. of tuition fees
                                                ...
                                                <tr>
                                                    <td>Income above Rs. 3L upto 5L</td>
                                                    <td>
                                                        Exemption from payment. of tuition fees
                                        ...
                                        <ol class="section-ol-list">
                                            ...
                                            <li>
                                                Tuition fee is waived off for SC/ST/PD category students.
                                            </li>
                                        </ol>
                                        <b>
                                            In case of any query or clarification, contact person in-charge of UG Scholarships in Academic Office
                                            <br>
					    ...
					    All the information for SBI Loan can be found <a href= "http://www.iitb.ac.in/newacadhome/sbiindex.jsp" target = "_blank">here</a>


                                        <br><br>
                                        <b>Vidyalaxmi loans</b>
                                        <ol class="section-ol-list">
                                            <li>
                                        ...
                                        <b>SBF (Student Benevolent Fund)</b>
                                        <ol class="section-ol-list">
                                            <li>
                                            ...
                                            <li>
                                                Bad performance of a student may lead the Dean to cancel the scholarship
                                            </li>
                                            <li>
                                                4% interest rate (which might be increased)
                                            </li>
                                            <li>
                                        ...
                                        <ol class="section-ol-list">
                                            ...
                                            <li>
                                                The student can contact the Alumni office through an online portal where they would be given the appropriate link to apply.
                                            </li>
                                            <li>
                                                Documents required for application - 12th Marksheets, JEE advanced results, Family income certificate, Parents Residential proof, Parents ID proof
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                For further information: Contact IIT Bombay Alumni Association Alumni Centre, 1st Floor Gulmohar Building, IIT Bombay e-mail: <a href="mailto:rama.iitbaa@gmail.com" class="link">rama.iitbaa@gmail.com</a> Tel: 022-25767086/7019
                                            </li>
                                        </ol>
                                    </div>
                                </div>
                ...
                <div id="side">
                    <div id="side_menu">
                        ...
                        <div class="side-menu-content">
                            <ul id="side_nav">
                                <li><a class="nav-link active" href="#letter-to-parents">Letter to Parents</a></li>
                                <li><a class="nav-link" href="#hindi-parents-letter">अभिभावक को पत्र</a></li>
                                <li><a class="nav-link" href="#fee-structure">Fee Structure</a></li>
                                <li><a class="nav-link" href="#scholarships-available">Scholarships Available</a></li>
                                <li><a class="nav-link" href="#accommodations-available">Accommodations Available</a></li>
                            </ul>
                        </div>
                    </div>
                    <div id="news_section">
