...
<head>
    ...
    <meta property="og:title" content="Department - Civil Engineering | SMP - IIT Bombay" />
    <meta property="og:description" content="Get to know about our IIT Bombay" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Department - Civil Engineering | SMP - IIT Bombay</title>
...
<main>
    <!-- slider Area Start-->
    <div class="slider-area d-flex align-items-center" style="background-image: url('assets/img/academics/departments/bg/civil.jpg');">
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-7 col-md-8">
                    <div class="hero__caption">
                        ...
                        <h1 data-animation="fadeInLeft" data-delay=".5s" >Civil Engineering</h1>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Structural Engineering</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Fluid Mechanics</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Hydrology</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Remote Sensing</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Geotechnical Engineering</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Transportation Engineering</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Construction Technology and Management</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Ocean Engineering</p>
                    ...
                    <section id="dept-alum">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Akshat Bansal, Civil Engineering Dual Degree (2010)</p>
                                        ...
                                        <br><br>
                                        <p class="section-sub-heading mb-1">Tanmay Pandya, Civil Engineering Btech (2013)</p>
                    ...
                    <section id="student-activities">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="section-content">
                                        <p class="section-sub-heading mb-1">Akaar</p>
                                        ...
                                        <br><br>
                                        Visit our website <a href="https://www.civil.iitb.ac.in/cea/aakaar/index1.php" class="link">here</a>.
                                    </div>
                                </div>
                            </div>
                        </div>
